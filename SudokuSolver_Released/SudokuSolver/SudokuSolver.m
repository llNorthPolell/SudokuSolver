...
p_crossover=0.7;               % Rate of crossover %

p_mutation=0.01;                % Rate of mutation %
...
while (generations<=max_generations)
    ...
    for i=1:population_size
        ...
        % Remove these to test with "Rate of Solution Experiment" settings / add %{ %} around following % 
    ...
    generations=generations +1;                         % Update the generations passed %
end



displaySolution(pop(:,getMinFV(FV)),maximum_value);                 % Display the solution in sudoku form %